...
public class DisasterNotificationDBfunctionO  {

	private static volatile DisasterNotificationDBfunctionO disasterNotificationDBfunction;

	public static DisasterNotificationDBfunctionO getInstance() {
		if (disasterNotificationDBfunction == null) {
			synchronized (DisasterNotificationDBfunctionO.class) {
				disasterNotificationDBfunction = new DisasterNotificationDBfunctionO();
			}
		}
...
//		String SQL = "select * from safetaiwan_disasternotification ";
	...
	public Connection getConnection() {
		InterfaceDBSource InterfaceDB = null;
		Connection conn = null;
		
			try {
				InterfaceDB = new DBSourceO();
				conn = InterfaceDB.getConnection();
